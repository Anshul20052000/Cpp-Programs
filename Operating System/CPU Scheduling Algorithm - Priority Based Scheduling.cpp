...
int main()
{
    cout<<"Shortest Job First[SJF] CPU Scheduling Algorithm "<<endl<<endl;
    string process_name[10];
    int arrival[10],priority[10],burst[10],waiting[10],turnaround[10],start[10],completion[10];
    int n;
    float total_waiting_time = 0, total_turnaround_time = 0;
    cout<<"Enter the Number of Processes : ";
    cin>>n;
    cout<<"\n Note : Lower the Number Higher the Priority\n\n";
    cout<<"Enter the Process Name, Arrival Time, Burst Time and Priority of the Processes : \n"<<endl;
    for(int i=0;i<n;i++)
    {
    ...
    cout<<"Order of Processes in Descending Order of there Priority : "<<endl;
    for(int i=0;i<n;i++)
    {
        cout<<process_name[i]<<" > ";
    }
    ...
    cout<<"  Process Name   |   Priority    | Arrival Time  |  Burst Time   |   Start Time  |  Completion   |  Turnaround   | Waiting Time  |"<<endl;
    cout<<"                 |               |               |               |               |               |               |               |"<<endl;
    for(int i=0;i<n;i++)
    {
        cout<<i+1<<".   "<<process_name[i]<<"\t |   "<<priority[i]<<"\t\t |   "<<arrival[i]<<"\t\t |   "<<burst[i]<<"\t\t |   "<<start[i]<<"\t\t |   "<<completion[i]<<"\t\t |   "<<turnaround[i]<<"\t\t |   "<<waiting[i]<<"\t\t |"<<endl;

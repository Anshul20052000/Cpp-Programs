...
int main()
{
    ...
    cout<<"Now Popping Begins..."<<endl;
    cout<<"The Stack is : "<<endl;
    Display(top);
    cout<<"Want to Pop Element from the Stack...[Y/N]..."<<endl;
    cin>>ch;
    while(ch=='Y'||ch=='y')
    {
        cout<<"Popping Element From the top of the Stack..."<<endl;
        Pop();
        cout<<"Now the Stack is : "<<endl;
        Display(top);
        cout<<"Want to Delete More Element from the Top of the Stack [Y/N] : "<<endl;
        cin>>ch;
    }
    Delete(top);
    return 0;
